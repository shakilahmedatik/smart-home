...
const Cart = () => {
  return (
    <div className="max-w-full flex justify-center items-center dark:bg-gray-900 dark:text-gray-100">
      <div className="flex flex-col max-w-3xl p-6 space-y-4 sm:p-1">
